...
namespace {
    ...
    class Setting extends \Philf\Setting\Facades\Setting{
        ...
        public static function path($path){
            return \Philf\Setting\Setting::path($path);
        }
        ...
        public static function filename($filename){
            return \Philf\Setting\Setting::filename($filename);
        }
        ...
        public static function get($key = null, $default = null){
            return \Philf\Setting\Setting::get($key, $default);
        }
         ...
         */
        public static function set($key, $value){
            \Philf\Setting\Setting::set($key, $value);
        }
        ...
        public static function forget($deleteKey){
            \Philf\Setting\Setting::forget($deleteKey);
        }
        ...
        public static function has($searchKey){
            return \Philf\Setting\Setting::has($searchKey);
        }
        ...
        public static function load($path = null, $filename = null){
            return \Philf\Setting\Setting::load($path, $filename);
        }
        ...
        public static function save($path = null, $filename = null){
            \Philf\Setting\Setting::save($path, $filename);
        }
         ...
         */
        public static function clear(){
            return \Philf\Setting\Setting::clear();
        }
        ...
        public static function setArray($data){
            return \Philf\Setting\Setting::setArray($data);
        }
